      ...
      <SimpleGrid columns={2} spacing={1}>
        ...
        <Box height="150px">
          <blockquote
            ...
            data-instgrm-permalink="https://www.instagram.com/p/ChMN8IqM2Tj/?utm_source=ig_embed&utm_campaign=loading"
          ...
          >
            <div style={{ padding: '16px' }}>
              {' '}
              <a
                href="https://www.instagram.com/p/ChMN8IqM2Tj/?utm_source=ig_embed&utm_campaign=loading"
                style={{
                  background: '#FFFFFF',
                  lineHeight: 0,
                  padding: '0 0',
              ...
              >
                <a
                  ...
                  target="_blank"
                >
                  A post shared by خالد المجاهد | مبرمج 🖥 (@ikhaledmojahed)
                </a>
              </p>
            </div>
          </blockquote>
